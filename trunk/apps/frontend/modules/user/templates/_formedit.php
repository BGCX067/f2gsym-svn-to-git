...
<?php endif; ?>
  <table>
    ...
    <tbody>
      ...
      <?php foreach($form->getObject()->getDireccion() as $direccion){ ?>
      
     
      <tr>
        <th>Direccion</th>
        <td>
          <?php echo $direccion->getAlias().': <br/>'.$direccion->getDireccion().', '.$direccion->getCiudad().', '.$direccion->getEstado().', ZIP: '.$direccion->getZip(); ?>
        </td>
      </tr>      
