...
/**
 * Itemsmenu filter form base class.
 *
 * @package    fit2go
 * @subpackage filter
 ...
 */
abstract class BaseItemsmenuFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('itemsmenu_filters[%s]');
