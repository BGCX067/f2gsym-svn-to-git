...
/**
 * Testimonio filter form base class.
 *
 * @package    fit2go
 * @subpackage filter
 ...
 */
abstract class BaseTestimonioFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('testimonio_filters[%s]');
