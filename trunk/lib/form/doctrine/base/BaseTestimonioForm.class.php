...
/**
 * Testimonio form base class.
 *
 * @method Testimonio getObject() Returns the current form's model object
 *
 * @package    fit2go
 * @subpackage form
 ...
 */
abstract class BaseTestimonioForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('testimonio[%s]');
